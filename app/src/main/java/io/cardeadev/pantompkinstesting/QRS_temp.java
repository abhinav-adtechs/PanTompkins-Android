...
public class QRS_temp {
    ...
    public static void main(String[] args) throws IOException {
        ...
        ArrayList<String> data_list = readCSVToArrayList("/Users/abhinav/Downloads/datamod.csv");
        ...
        try {
            FileWriter fw = new FileWriter( "/Users/abhinav/Downloads/QRS.csv",true);
